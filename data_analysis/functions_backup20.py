...
def checkIfdepthDataDfHasBeenSaved(turtlesData):
    for turtleData in turtlesData:
        ...
        #turtleData.checkIfDfHasBeenSavedAndSaveDf(self.DATACLEANINGRESULTS_FOLDER_ITENS, self.DATACLEANINGRESULTS_FOLDER , self.remainingDataDf, self.remainingDataDfCsvName)
    

# def checkIfDfHasBeenSaved(turtlesData):
#     saveDataFrame(td.remainingDataDf, pathToFilePlusCsvName)

#     folderToSaveItems, folderToSave, dataframe, stringDfName
#     filesInResultsFolder = []       
...
# def checkIfDfHasBeenSaved(folderToSaveItems, folderToSave, dataframe, stringDfName):
#     filesInResultsFolder = []       
#     for file in folderToSaveItems:
#         filesInResultsFolder.append(file)    
#     print(filesInResultsFolder)
